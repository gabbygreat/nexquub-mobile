...
Map<Color, Color> match = {
  PakeColors.neutralLight800: PakeColors.neutralDark800,
  PakeColors.neutralLight600: PakeColors.neutralDark600,
  PakeColors.neutralDark600: PakeColors.neutralLight600,
  PakeColors.neutralLight300: PakeColors.neutralDark300,
  PakeColors.neutralLight100: PakeColors.neutralDark100,
};
...
extension AdaptiveColor on Color {
  Color of(BuildContext context, {Color? blackColor}) {
    ...
    assert(
      match[this] != null || blackColor != null,
...
class PakeColors {
  ...
  // -> Material Colors
  static const MaterialColor _neutralDark =
      MaterialColor(0xFF333440, <int, Color>{
        50: Color(0xFF333440),
  ...
  static const MaterialColor _neutralLight =
      MaterialColor(0xFFF2F2F5, <int, Color>{
        50: Color(0xFFF2F2F5),
  ...
  static const MaterialColor _primaryDark =
      MaterialColor(0xFF00060F, <int, Color>{
  ...
  static const MaterialColor _primaryLight =
      MaterialColor(0xFFF1F7FF, <int, Color>{
  ...
  static const MaterialColor _red = MaterialColor(0xFFF9EDED, <int, Color>{
    50: Color(0xFFF9EDED),
  ...
  static const MaterialColor _green = MaterialColor(0xFFE8F9EA, <int, Color>{
    50: Color(0xFFE8F9EA),
  ...
  static const MaterialColor _warning = MaterialColor(0xFFFBF7E7, <int, Color>{
    50: Color(0xFFFBF7E7),
  ...
  static const LinearGradient bgNight = LinearGradient(
    ...
    colors: [Color(0xFF001C43), Color(0xFF00060F)],
    stops: [0, 1],
  );
  static const LinearGradient linear = LinearGradient(
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
    colors: [Color(0xFF003D98), Color(0xFF9F159F)],
    stops: [0, 1],
  );
}
